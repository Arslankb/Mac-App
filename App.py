...
l1 = Label(LHS, text=my_system.node, bg="#f4f5f5", font=("Acumin Varible Concept",15, "bold"),justify="center")
l1.place(x=20, y=200)

l2 = Label(LHS, text=f"Version: {my_system.version}", bg="#f4f5f5", font=("Acumin Varible Concept",8),justify="center")
l2.place(x=20, y=225)

l3 = Label(LHS, text=f"System: {my_system.system}", bg="#f4f5f5", font=("Acumin Varible Concept",15),justify="center")
l3.place(x=20, y=250)

l4 = Label(LHS, text=f"Machine: {my_system.machine}", bg="#f4f5f5", font=("Acumin Varible Concept",15),justify="center")
l4.place(x=20, y=285)

l5 = Label(LHS, text=f"Total Ram Installed:{round(psutil.virtual_memory().total/1000000000, 2)}GB", bg="#f4f5f5", font=("Acumin Varible Concept",15),justify="center")
l5.place(x=20, y=310)

l6 = Label(LHS, text=f"Processor: {my_system.processor}", bg="#f4f5f5", font=("Acumin Varible Concept",6 ,'bold'),justify="center")
l6.place(x=20, y=340)
...
lb1_brightness = Label(RHS, text="Brightness", font=("arial", 10, 'bold'), bg="#bf4bf5bf5")
...
def weather():
    ...
    label1 = Label(app1, text='HUMIDITY', font=('Helvatica', 15, 'bold'), fg='white', bg='#1ab5ef')
    label1.place(x=250, y=400)

    label1 = Label(app1, text='DESCRIPTION', font=('Helvatica', 15, 'bold'), fg='white', bg='#1ab5ef')
    label1.place(x=450, y=400)

    label1 = Label(app1, text='PRESSURE', font=('Helvatica', 15, 'bold'), fg='white', bg='#1ab5ef')
...
def calandar():
    ...
    mycal=Calendar(app3,setmode='day', date_pattern = 'd/m/y')
...
app3 = Button(RHB, image=app3_image, bd=0 , command=calandar)
